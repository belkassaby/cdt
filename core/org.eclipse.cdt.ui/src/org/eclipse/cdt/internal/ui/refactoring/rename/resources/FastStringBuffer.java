...
public final class FastStringBuffer implements CharSequence {
	...
	public void clearMemory() {
		if (this.value.length > 128) {
			this.value = null; // make it available for gc before allocating the
								// new memory.
	 ...
	 * (but may be more) This code was inlined on all methods and it's kept here
	 * to use as a reference when needed (and to be used from clients to
	 * pre-reserve space).
	 */
	...
	/**
	 * Replaces all the occurrences of a string in this buffer for another
	 * string and returns the altered version.
	 */
