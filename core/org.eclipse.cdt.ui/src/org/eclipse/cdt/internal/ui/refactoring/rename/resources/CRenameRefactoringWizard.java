...
public class CRenameRefactoringWizard extends RefactoringWizard {
	...
	public CRenameRefactoringWizard(Refactoring refactoring, String defaultPageTitle,
	...
	protected TextInputWizardPage createInputPage(String message, final String initialSetting) {
		return new TextInputWizardPage(message, true, initialSetting) {
			...
			protected RefactoringStatus validateTextField(String text) {
				...
				if (StringUtils.isValidIdentifier(text, acceptPoint)) {
...
//						status.addInfo("Empty text: move to source folder"); //$NON-NLS-1$
//					} else {
...
//				}
				...
				bt.setText("as_&lower_underscore"); //$NON-NLS-1$
				...
				bt2.setText("CamelCaseFirst&Upper"); //$NON-NLS-1$
				...
				bt3.setText("&camelCaseFirstLower"); //$NON-NLS-1$

				// addOptionalUpdateTextualMatches(composite, layouter);
				// addOptionalUpdateQualifiedNameComponent(composite, layouter,
				// layout.marginWidth);
