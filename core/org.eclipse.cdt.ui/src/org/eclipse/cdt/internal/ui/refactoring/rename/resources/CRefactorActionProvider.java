...
public class CRefactorActionProvider extends CommonActionProvider {

	private CRenameResourceAction renameResourceAction;
	...
	public void init(ICommonActionExtensionSite aSite) {
		...
		if (viewSite instanceof ICommonViewerWorkbenchSite) {
			...
			renameResourceAction = new CRenameResourceAction(shell, site.getSelectionProvider());
		}
	}
